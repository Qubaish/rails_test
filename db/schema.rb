...
ActiveRecord::Schema.define(version: 20171018122938) do
  ...
  create_table "bugs", force: :cascade do |t|
    ...
    t.index ["creator_id"], name: "index_bugs_on_creator_id", using: :btree
    t.index ["project_id"], name: "index_bugs_on_project_id", using: :btree
